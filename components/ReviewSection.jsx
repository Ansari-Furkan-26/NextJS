    ...
    <div className="bg-[#F3F4F6] py-8 px-4">
      ...
      <div className="text-center mt-10">
        <div className="flex items-center justify-center gap-2 mb-2">
          <img
            src="/logo/english_logo.png"
            alt="Rukn Al Dyafa"
            className="w-18 h-12"
          />
        </div>
        <p className="text-yellow-500 text-2xl font-bold">5.0 ★</p>
        {/* <p className="text-gray-500 text-sm">9 reviews</p> */}

        <div className="text-lg text-gray-500 mt-1 flex items-center justify-center gap-2">
          <p>Powered by</p>
          <img
