...
export default function HomePage() {
  ...
  const translations = {
    ...
    arabic: {
      heading: "نكهات تحكي قصصًا، وضيافة تلهم اللحظات.",
      paragraph:
        "في ركن الضيافة، نقدم أناقة الضيافة التقليدية من خلال خدمات فاخرة، نصنع تجارب لا تُنسى بمشروباتنا المميزة لكل مناسبة.",
      bookNow: "احجز الآن",
    },
  };
  ...
  return (
    <div className="relative bg-black min-h-screen flex flex-col">
      ...
      <button
        ...
        className="absolute top-4 right-4 bg-gray-800 hover:bg-gray-600 text-white py-2 px-4 rounded-full transition"
      >
